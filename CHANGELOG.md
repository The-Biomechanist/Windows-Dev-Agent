...
- Consolidate captured external execution into a bounded streaming runner. Settle stdout/stderr drain threads before publishing a receipt; Windows cancels still-blocked synchronous reads after a short EOF grace period and reports clean capture completion separately from reader settlement.
