...
function Get-WslRouteImplementationAllowed {
    ...
    # Match sandbox routing authority: a Store package is installation evidence,
    # but only registered service implementations are route evidence. Any failed
    # service-state read preserves unknown instead of being bypassed by package state.
